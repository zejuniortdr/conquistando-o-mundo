...
pais: Coreia do Sul
paisCodigo: KR
coordenadas: [37.5665, 126.978]
datas:
  inicio: "2026-12-29"
  fim: "2027-01-05"
moeda: KRW
custoDia: "₩100.000-150.000 por pessoa, sem contar compras"
idioma: Coreano
visto: Passaporte brasileiro não precisa de visto para turismo de até 90 dias, mas é preciso tirar a K-ETA (autorização eletrônica de viagem, cerca de ₩10 mil, válida por 3 anos) pelo menos 72 horas antes do embarque — o Brasil não aparece na lista de países temporariamente isentos; confirmar no site oficial k-eta.go.kr.
tomada: Padrões C e F (dois pinos redondos), 220V — aparelhos brasileiros de 220V funcionam direto; o plugue brasileiro às vezes encaixa frouxo, então vale levar um adaptador.
...
pontos:
  - nome: Gyeongbokgung
    resumo: O maior dos cinco palácios da dinastia Joseon, construído em 1395, com as montanhas ao fundo. Entrada de cerca de ₩3 mil; troca da guarda na entrada principal às 10h e às 14h. Fecha às terças.
  - nome: Praça Gwanghwamun
    resumo: Avenida-praça em frente ao Gyeongbokgung com as estátuas do Rei Sejong, que criou o alfabeto coreano, e do Almirante Yi Sun-sin, herói naval.
  - nome: Bukchon Hanok Village
    resumo: Ladeiras de hanok (casas tradicionais de madeira e telhado curvo) entre os palácios, com vista para a cidade. É bairro residencial — turista só das 10h às 17h, em silêncio.
  - nome: Ikseon-dong
    resumo: Becos estreitos de hanok transformados em cafés, docerias e lojinhas, menor e mais charmoso que Insadong.
  - nome: Insadong
    resumo: Rua de artesanato, papelaria tradicional, galerias e casas de chá, com o shopping Ssamziegil em rampa espiral.
  - nome: Café Onion Anguk
    resumo: Padaria-café dentro de um hanok antigo, famosa pelo pandoro (pão doce alto coberto de açúcar de confeiteiro). Fila de manhã.
  - nome: Cheonggyecheon
    resumo: Riacho canalizado que corta o centro por 11 km, com calçadão abaixo do nível da rua. No fim do ano costuma receber as luzes do festival Seoul Winter Festa.
  - nome: Deoksugung e Doldam-gil
    resumo: Palácio pequeno ao lado da prefeitura, mistura de arquitetura coreana e ocidental, com a rua do muro de pedra (Doldam-gil) ao redor. Fecha às segundas; bonito também à noite.
  - nome: Sino de Bosingak
    resumo: Pavilhão do sino da cidade, de 1396, em Jongno. Na virada do ano o sino toca 33 vezes na contagem oficial de Seul, com centenas de milhares de pessoas na rua.
  - nome: Olive Young Myeongdong
    resumo: A loja principal da rede de skincare mais visitada por turistas, com vários andares, testers de tudo e o imposto descontado direto no caixa apresentando o passaporte.
  - nome: Olive Young N Seongsu
    resumo: Loja-conceito mais nova da Olive Young, no bairro de Seongsu, com diagnóstico de pele, experiências e lançamentos que chegam ali primeiro.
  - nome: Daiso Myeongdong
    resumo: Daiso coreana de 12 andares; a linha de skincare barata faz sucesso com turistas.
  - nome: Sulwhasoo Flagship
    resumo: Loja-conceito da marca de skincare de luxo à base de ginseng, num prédio de cinco andares no bairro de Sinsa, com spa (reserva à parte).
  ...
  - nome: Lotte World Tower e Seoul Sky
    resumo: O prédio mais alto da Coreia, com 555 m e mirante de chão de vidro nos últimos andares; embaixo, o shopping Lotte World Mall.
  - nome: JYP Center
    resumo: Sede da JYP Entertainment, a agência do Stray Kids, perto do Olympic Park. Não tem tour nem loja — o programa é a foto na fachada, e o Starbucks em frente é ponto de encontro de fãs.
  - nome: Yongsan I'Park Mall
    resumo: Shopping colado à estação Yongsan com um andar grande de brinquedos, figures e Nintendo, ao lado do antigo mercado de eletrônicos da cidade.
  - nome: DDP (Dongdaemun Design Plaza)
    resumo: Prédio futurista de curvas prateadas projetado por Zaha Hadid, cercado pelos shoppings de moda de Dongdaemun, que abrem até de madrugada.
...
### Dia 5 · 02/01 (sáb) · DMZ ou Seongsu sem pressa
Se o tour da DMZ entrar — zona desmilitarizada na fronteira com a Coreia do Norte, com o 3º Túnel e o Observatório Dora, das 7h30 às 15h —, é neste dia, o único sábado útil. Sem DMZ, o dia vai para Seongsu por inteiro e para a Sulwhasoo Flagship (loja-conceito de skincare de luxo com ginseng) em Sinsa. À noite, Hongdae (bairro universitário, artistas de rua dançando K-pop e lojas de máquinas de garra), se quiserem.

### Dia 6 · 03/01 (dom) · Jamsil e a JYP
Lotte World Tower (o prédio mais alto da Coreia) com o mirante Seoul Sky e o shopping embaixo, e dali duas estações até a JYP Center para a foto na fachada da agência do Stray Kids. Se a Sulwhasoo não entrou no dia anterior, entra no fim da tarde.

### Dia 7 · 04/01 (seg) · Bate-volta ou Seul livre
